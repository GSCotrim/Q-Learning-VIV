...
if __name__ == "__main__":
    ...
    discount_factor = 0.9
    epsilon = 0.1
    initial_conditions = [0.0, 0.0, 1.0, 0.0]  # Condições iniciais do oscilador acoplado
    num_states = 10
    num_actions = 9
    ...
    save_q_table(Q_table, '/home/gscotrim/Documents/TCC/RL/Q-Learning-VIV/data/Q_table.npy')
    save_plot('/home/gscotrim/Documents/TCC/RL/Q-Learning-VIV/data/q_table.png')
    save_plot('/home/gscotrim/Documents/TCC/RL/Q-Learning-VIV/data/reward_history.png')
